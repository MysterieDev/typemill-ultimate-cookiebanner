...
const b = t("<h4></h4>"),
    g = t(
        '<p class="marginBtns"><br><small style="font-weight: bold;">..</small></p>'
    ),
    h = t(
        '<table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth"><thead><tr><th></th><th></th><th></th></tr></thead><tbody></tbody></table>'
    ),
    w = t("<tr><td></td><td></td><td></td></tr>");
...
const L = t('<button class="button  btn-accept-all"></button>'),
    x = t('<div class="column"></div>'),
    R = t(
        '<div class="columns"><div class="column"><button class="button is-small is-secondary"></button></div><div class="column"></div></div>'
    ),
    $ = t(
        '<div id="backgroundContainer"><div class="container cookieContainer content"><h2> </h2><p></p><div class="columns mt-2"><div class="column"><button class="button is-small is-secondary"></button></div></div></div></div>'
    ),
    F = () => {
        function e() {
            return (() => {
...
if (B) {
    B.outerHTML = '<div id="cbReqTable"></div>';
...
I &&
    ((I.outerHTML = '<div id="cbFunTable"></div>'),
        d(
            () =>
            i(k, {
                get category() {
...
A &&
    ((A.outerHTML = '<div id="cbMarTable"></div>'),
        d(
            () =>
            i(k, {
                get category() {
